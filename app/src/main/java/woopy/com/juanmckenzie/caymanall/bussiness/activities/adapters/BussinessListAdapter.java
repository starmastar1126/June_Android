package woopy.com.juanmckenzie.caymanall.bussiness.activities.adapters;
 ...
 * All rights reserved
 */
public class BussinessListAdapter extends RecyclerView.Adapter<BussinessListAdapter.AdsListVH> {
    ...
    public BussinessListAdapter(List<Ads> adsList, List<Banner> promotions, Context context, OnAdClickListener onAdClickListener) {
