...
public class JobApplicationsRecived extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mlTitleTxt.setText(getString(R.string.received_application));
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if (ads.getSellerPointer().getFirebaseID().equals(myapplication.getCurrentUser().getFirebaseID()))
                        if (ads.getCategory().equals("Jobs"))
                            if (ads.getAllDone())
                                MyAds.add(ads);
                }


                Collections.sort(MyAds, new Comparator<Ads>() {
                ...
                if (MyAds.isEmpty()) {
                    ...
                    myAdsRV.setLayoutManager(new LinearLayoutManager(JobApplicationsRecived.this));
                    myAdsRV.setAdapter(new MyAdsAdapter(MyAds, JobApplicationsRecived.this, new MyAdsAdapter.OnMyAdClickListener() {
                        @Override
    ...
    private void startSellEditItemScreen(Ads adObjid) {
        if (adObjid != null) {
            ...
            Intent i = new Intent(JobApplicationsRecived.this, JobApplications.class);
