...
public class AdDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ads_loading_content);
        ...
        try {
            ...
            optionsBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    alert.setMessage(getString(R.string.selectoption))
...
//                                    Uri fileUri = FileUtils.getUri(imageFile);
                                    ...
                                    Task<ShortDynamicLink> shortLinkTask = FirebaseDynamicLinks.getInstance().createDynamicLink()
                                            ...
                                            .setSocialMetaTagParameters(new DynamicLink.SocialMetaTagParameters.Builder()
                                                    ...
                                                    .setImageUrl(Uri.parse(adObj.getImage1().getUrl()))
                                                    .setDescription(adObj.getDescription())
                                                    .build())
                                            .setAndroidParameters(androidParameters)
                                            .buildShortDynamicLink()
                                            .addOnCompleteListener(AdDetailsActivity.this, new OnCompleteListener<ShortDynamicLink>() {
                                                @Override
            ...
            chatIV.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (FirebaseAuth.getInstance().getCurrentUser() != null) {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (user.getHasBlocked() != null) {
                                    if (user.getHasBlocked().contains(configs.getCurrentUser().getFirebaseID())) {
                                        Configs.simpleAlert(getString(R.string.sorry) + user.getUsername() + getString(R.string.has_blocked_message), AdDetailsActivity.this);
                                    } else {
                                        configs.setSelectedAd(adObj);
                        ...
                        Configs.loginAlert(getString(R.string.you_must_login), AdDetailsActivity.this);
                    }
                }
            });
            ...
            likeIV.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (FirebaseAuth.getInstance().getCurrentUser() != null) {
                        ...
                        Configs.loginAlert(getString(R.string.login_mesage), AdDetailsActivity.this);
                    }
        ...
        findViewById(R.id.applyforjob).setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                FirebaseDatabase.getInstance().getReference().child("ads").child(adObj.getID()).child("applications").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (formobject != null) {
                            ...
                            builder.setMessage(getString(R.string.already_applied))
                                    .setTitle(R.string.app_name)
                                    .setCancelable(true)
    ...
    void queryIfYouLikedThisAd() {
        ...
        FirebaseDatabase.getInstance().getReference().child("users").child(adObj.getSellerPointer().getFirebaseID()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                joinedTV.setText(Configs.timeAgoSinceDate(date1, getApplicationContext()));

                // Get verified
                verifiedTV.setTypeface(Configs.titRegular);
                if (user.getEmailVerified() != null) {
                    if (user.getEmailVerified()) {
                        verifiedTV.setText("Yes");
                    } else {
                        verifiedTV.setText("No");
                    }
                } else {
                    verifiedTV.setText("No");
                }
                ...
                Glide.with(AdDetailsActivity.this).setDefaultRequestOptions(requestOptions)
                        .load(user.getAvatar()).into(avatarIV).clearOnDetach();
    ...
    void showAdDetails() {
        imagesAdapter = new AdImagesPagerAdapter(adObj, getApplicationContext(), imagesVP, new AdImagesPagerAdapter.OnImageClickListener() {
            @Override
        ...
        if (adObj.getCategory().equals("Jobs")) {
            findViewById(R.id.applyforjob).setVisibility(View.VISIBLE);
        } else {
            findViewById(R.id.applyforjob).setVisibility(View.GONE);
        }
        ...
        if (adObj.getADStatus().equals("Pending")) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                drawable3 = new BadgeDrawable.Builder()
                        ...
                        .badgeColor(getColor(R.color.colorPrimary))
...
//                Toast.makeText(getApplicationContext(), "Geocoder not present!", Toast.LENGTH_SHORT).show();
        ...
        if (adObj.getVideo() != null) {
            playVideoTV.setText("Video: Watch");
            playVideoTV.setEnabled(true);
        } else {
            playVideoTV.setText("Video: N/A");
        ...
        if (sellerPointer.getEmailVerified() != null) {
            if (sellerPointer.getEmailVerified()) {
                ...
                verifiedTV.setText(getString(R.string.no));
            }
        } else {
            verifiedTV.setText(getString(R.string.no));
        }
        ...
        commentTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (FirebaseAuth.getInstance().getCurrentUser() != null) {
                    ...
                    Configs.loginAlert(getString(R.string.you_must_login_mesage), AdDetailsActivity.this);
                }
            }
        });
            ...
            public void onClick(View view) {
                if (FirebaseAuth.getInstance().getCurrentUser() != null) {
                    ...
                    if (configs.getCurrentUser().getFeedbacks().contains(adObj.getID())) {
                        Configs.simpleAlert(getString(R.string.you_already_sent), AdDetailsActivity.this);
                    } else {
                        configs.setSelectedAd(adObj);
                    ...
                    Configs.loginAlert(getString(R.string.you_must_have_to_logined), AdDetailsActivity.this);
                }
            }
        });
    }
