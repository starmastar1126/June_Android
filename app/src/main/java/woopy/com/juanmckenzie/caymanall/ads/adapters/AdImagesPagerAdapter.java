...
public class AdImagesPagerAdapter extends PagerAdapter {
    ...
    public AdImagesPagerAdapter(Ads adObject, Context context, ViewPager imagesVP, OnImageClickListener onImageClickListener) {
        ...
        if (Images.size() == 0) {
            imagesVP.beginFakeDrag();
            String image = "https://1m19tt3pztls474q6z46fnk9-wpengine.netdna-ssl.com/wp-content/themes/unbound/images/No-Image-Found-400x264.png";
            Images.add(image);
        }
